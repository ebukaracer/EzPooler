...
namespace Racer.EzPooler.Utilities
{
    /// <summary>
    ...
    public static class EzLogger
    {
        ...
        internal static void Log(object message, Object context = null, string tag = nameof(EzPooler))
        {
        ...
        internal static void Warn(object message, Object context = null, string tag = nameof(EzPooler))
        {
            if (!EnableLogs) return;
        ...
        internal static void Error(object message, Object context = null, string tag = nameof(EzPooler))
        {
            if (!EnableLogs) return;
